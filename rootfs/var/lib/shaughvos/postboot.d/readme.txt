# /var/lib/shaughvos/postboot.d is implemented by shaughvOS and allows to run scripts at the end of the boot process:
# - /etc/systemd/system/shaughvos-postboot.service => /boot/shaughvos/postboot => /var/lib/shaughvos/postboot.d/*
